...
module.exports = function(objects) {
  ...
  function arcifyFeature(feature) {
    ...
    if ("id" in feature) arcifiedFeature.id = feature.id;
    if ("properties" in feature) arcifiedFeature.properties = feature.properties;
    return arcifiedFeature;
  }
  ...
  function arcifyGeometry(geometry) {
    ...
    if (geometry.type === "GeometryCollection") return {
      ...
      geometries: geometry.geometries.map(arcifyGeometry)
    };
  ...
  var arcifyObjectType = {
    ...
    FeatureCollection: function(collection) {
      return {
        ...
        features: collection.features.map(arcifyFeature)
      };
    }
  };
