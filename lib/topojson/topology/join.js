...
module.exports = function(topology) {
  var coordinates = topology.coordinates,
      ...
      visitedByPoint,
      neighborsByPoint = hashtable(coordinates.length * 1.4, hashPoint, equalPoint),
      junctionByPoint = hashtable(coordinates.length * 1.4, hashPoint, equalPoint);
  ...
  for (var i = 0, n = lines.length; i < n; ++i) {
    ...
    visitedByPoint = hashtable((lineEnd - lineStart) * 1.4, hashPoint, equalPoint);
  ...
  for (var i = 0, n = rings.length; i < n; ++i) {
    ...
    visitedByPoint = hashtable((ringEnd - ringStart + 1) * 1.4, hashPoint, equalPoint);
