...
module.exports = function(objects, options) {
  ...
  if (options)
    ...
    "ignore-self-intersections" in options && (ignoreSelfIntersections = !!options["ignore-self-intersections"]);
  ...
  var topology = topologize(objects, {ignoreSelfIntersections: ignoreSelfIntersections});
