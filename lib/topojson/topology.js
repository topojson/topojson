...
module.exports = function(objects, options) {
  ...
  if (Q) {
    geometryTransform = quantize(bbox, Q);
    if (verbose) {
      console.warn("quantization: " + geometryTransform.transform.scale.map(function(degrees) { return system.formatDistance(degrees / 180 * Math.PI); }).join(" "));
    }
  }
