      ...
      for (var j = 0, m = polygon.length; j < m; ++j) {
        ...
        ring: for (var i = 0, n = ring.length; i < n; ++i) {
          ...
          if (x <= x0e || x >= x1e || y <= y0e || y >= y1e) {
            ...
            if (i) {
              ring[i] = normalizePoint(ring[i][1]);
              var fragmentBefore = ring.slice(0, i + 1);
              // console.warn(ring[i], normalizePoint(y));
        ...
        for (var i = 0; i < n; ++i) {
          ...
          if (fragment) {
            ...
            // if (fragment.some(function(p) { return p == null; })) debugger;
            // if (startFragment && startFragment.some(function(p) { return p == null; })) debugger;
            // if (endFragment && endFragment.some(function(p) { return p == null; })) debugger;

            delete fragmentByStart[start];
            delete fragmentByEnd[end];

            if (startFragment) {
              // console.warn("joining fragment " + i + " (" + fragment.index + ") to fragment " + startFragment.index + " by start");
              ...
              // debugger;
              // console.warn("joining fragment " + i + " (" + fragment.index + ") to fragment " + endFragment.index + " by end");
